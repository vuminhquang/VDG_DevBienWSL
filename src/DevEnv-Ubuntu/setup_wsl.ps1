...
$osTarPath = Join-Path -Path $env:TEMP -ChildPath "ubuntu-oracular-oci-amd64-root.tar.gz"
...
if (-Not (Download-File -url $debianTarUrl -outputPath $osTarPath)) {
...
wsl --import $wslName $wslStoragePath $osTarPath --version 2

# Remove the downloaded tar file
Write-Message "Cleaning up the downloaded tar file..."
Remove-Item -Path $osTarPath
